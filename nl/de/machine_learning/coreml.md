...
Sie können Core ML und Watson Visual Recognition zu einer Swift-Anwendung hinzufügen, indem Sie die folgenden Schritte ausführen, um ein Modell zu trainieren und zu erstellen, Abhängigkeiten herunterzuladen und zu erstellen sowie eine Bildklassifizierung hinzuzufügen.{: shortdesc}
...
Hiermit ist alles vorbereitet. Nun können Sie Ihr Core ML-Modell herunterladen und es mithilfe des [Swift-SDK für Watson Developer Cloud](https://github.com/watson-developer-cloud/swift-sdk){:new_window} in Ihre App integrieren.
...
2. Übergeben Sie den API-Schlüssel und die Version, um das SDK zu initialisieren:
  ...
  Ziehen Sie die [Versionsparameterdokumentation](https://cloud.ibm.com/apidocs/visual-recognition#versioning) zurate oder verwenden Sie das Datum, an dem der {site.data.keyword.visualrecognitionshort}}-Service erstellt wurde.
  {: tip}
...
5. Erkunden Sie die anderen [Core ML-Klassifizierungsfunktionen](https://watson-developer-cloud.github.io/swift-sdk/services/VisualRecognitionV3/index.html), die vom Watson-SDK unterstützt werden.
