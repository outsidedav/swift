...
{{site.data.keyword.engage_short}} 服务可定义功能部件，根据设备平台（包括定制受众属性）创建受众，并最终定义参与来编排功能部件的计时和位置。使用 SDK 以及应用程序中包含的功能部件和度量值属性后，服务会开始度量受众体验。现在您可以根据此信息来利用应用程序，以创建用于各种应用程序用户类别的定制客户参与。
