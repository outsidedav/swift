...
要在应用程序中使用 MongoDB 数据库，请参阅[数据库使用入门](/docs/hypersecure_dbaas/database-cluster.html)。  
...
在成为发起方用户之前，可以使用 {{site.data.keyword.containershort_notm}} 来保护应用程序。有关更多信息，请参阅 [{{site.data.keyword.containershort_notm}} 入门](/docs/containers/container_index.html)。
